    ...
    <div className="hero-bg relative">
      ...
      <div className="flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto">
        ...
        <form onSubmit={handleFormSubmit} className="flex flex-col md:flex-row gap-4 w-1/2">
            ...
            <input type="email" className="p-2 rounded flex-1 bg-black/80 border border-gray-700" placeholder="Email address" id="email" value={email} onChange={(e) => setEmail(e.target.value)} />
      ...
      <div className="h-2 w-full bg-[#232323]" aria-hidden="true" />
        ...
        <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
            ...
            <div className="flex-1 relative overflow-hidden">
                ...
                <video playsInline autoPlay={true} muted loop className="absolute top-2 left-1/2 -translate-x-1/2 h-4/6 z-10 max-w-[63%]">
